...
;	     			selectedable startup tones, via the 'Beeper Volume' setting
;	    			custom beacon tone, should be easier to hear & not heat up motors.
; - Rev16.52 Fix for 32khz Multishot Calibration bug (redacted) 
